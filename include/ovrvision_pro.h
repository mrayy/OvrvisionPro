...
public:
	...
	int Open(int locationID, OVR::Camprop prop, int deviceType = -1, void *pD3D11Device = NULL, bool onlyGrabber = false);
	int OpenMemory(OVR::Camprop prop, int deviceType = -1, void *pD3D11Device = NULL);
	...
	//Callback
	void SetCallbackImageFunction(void(*func)(void*), void*ud);
	...
	*/
	...
	std::string  GetOVRSettings();
	void SetOVRSettings(const std::string& str);
